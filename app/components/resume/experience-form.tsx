      ...
      <CardContent className="pt-6 space-y-4">
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            ...
            />
            {showError("title") && (
              <p className="text-sm text-destructive">{errors[`${index}.title`]}</p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            />
            {showError("company") && (
              <p className="text-sm text-destructive">{errors[`${index}.company`]}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            ...
            />
            {showError("startDate") && (
              <p className="text-sm text-destructive">{errors[`${index}.startDate`]}</p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={experience.current ? "bg-muted cursor-not-allowed" : ""}
            />
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          />
          <Label htmlFor={`current-${index}`} className="cursor-pointer font-normal">
