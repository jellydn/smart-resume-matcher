...
import { History, Trash2, ChevronDown, ChevronUp, Building2, Briefcase, ExternalLink } from "lucide-react";
import type { JobHistoryEntry, JobDescription, JobRequirements } from "~/lib/types";

interface JobHistoryPanelProps {
  history: JobHistoryEntry[];
  onSelectEntry: (jobDescription: JobDescription, requirements?: JobRequirements) => void;
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            This will remove "{title}" from your job history. This action cannot be undone.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
